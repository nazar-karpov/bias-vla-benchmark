...
HALF=0.0715
OUT="/home/user/bias_benchmark/nazar_folder/Act2Answer/outputs"
PAIRS={e["index"]:e for e in json.load(open("/home/user/bias_benchmark/nazar_folder/Act2Answer/ManiSkill/mani_skill/assets/carrot/pairs_choice_vla_confirm/pairs.json"))}
CANON={"spatialvla":f"{OUT}/confirm-svla-ALL-*/glob/vis_0_test/stats.yaml"}
