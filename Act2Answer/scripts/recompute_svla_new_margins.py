...
CARDSET = "/home/user/bias_benchmark/nazar_folder/Act2Answer/ManiSkill/mani_skill/assets/carrot/pairs_choice_vla_confirm/pairs.json"
PAIRS = {e["index"]: e for e in json.load(open(CARDSET))}

# canonical full run per model (each alone = 1600 noswap + 1600 swap)
CANON = {
    "spatialvla": f"{OUT}/confirm-svla-ALL-*/glob/vis_0_test/stats.yaml",
